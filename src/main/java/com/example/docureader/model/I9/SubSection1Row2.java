...
public class SubSection1Row2 {

    @JsonProperty("textFieldAddress")
    private String textFieldAddress;
    @JsonProperty("textFieldAptNum")
    private String textFieldAptNum;
    ...
    @JsonProperty("textFieldAptNum")
    public String getTextFieldAptNum() {
        return textFieldAptNum;
    }

    @JsonProperty("textFieldAptNum")
    public void setTextFieldAptNum(String textFieldAptNum) {
        this.textFieldAptNum = textFieldAptNum;
    }
